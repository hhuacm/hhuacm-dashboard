...
function Field({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: Field follows the shadcn composition API; FieldSet provides semantic grouping when needed.
    <div
...
function FieldLabel({ className, ...props }: React.ComponentProps<"label">) {
  return (
    // biome-ignore lint/a11y/noLabelWithoutControl: Consumers associate FieldLabel with the control through htmlFor or nested fields.
    <label
      className={cn(
        "group/field-label peer/field-label flex w-fit select-none items-center gap-2 text-xs leading-snug peer-disabled:cursor-not-allowed peer-disabled:opacity-50 has-[>[data-slot=field]]:rounded-none has-[>[data-slot=field]]:border has-data-checked:border-primary/30 has-data-checked:bg-primary/5 *:data-[slot=field]:p-2 group-data-[disabled=true]/field:pointer-events-none group-data-[disabled=true]/field:opacity-50 dark:has-data-checked:border-primary/20 dark:has-data-checked:bg-primary/10",
